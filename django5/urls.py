...
from modelapp.views import HomeView,InsertInput,InsertView,DisplayView,DeleteInputView,DeleteView,UpdateInputView,UpdatView
...
urlpatterns = [
    ...
    path('modelapp/updateinput/update/',UpdatView.as_view()),
]
